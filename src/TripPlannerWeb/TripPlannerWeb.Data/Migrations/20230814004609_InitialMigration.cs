    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DayPlanningId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TripDayId = table.Column<int>(type: "int", nullable: false),
                    CodeUtc = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayPlannings", x => x.DayPlanningId);
                    table.ForeignKey(
                        name: "FK_DayPlannings_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "CountryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DayPlannings_TripDays_TripDayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayPlannings_CountryId",
                table: "DayPlannings",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_DayPlannings_TripDayId",
                table: "DayPlannings",
                column: "TripDayId");
